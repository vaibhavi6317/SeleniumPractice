...
System.out.println("Substring from index 4:" + s1.substring(4));//JavaBasics

// Returns the substring from i to j-1 index.
System.out.println("Substring from 3 to 6: " + s1.substring(3,6));//eJa
...
System.out.println("3 string concatebated ="+s1+s2+s3);
...
String str5=" ";
System.out.println("str5 is empsty or not: "+str5.isEmpty());
